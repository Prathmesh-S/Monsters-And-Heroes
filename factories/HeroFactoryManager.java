...
public class HeroFactoryManager {
    ...
    private HeroFactory[] factories = {new PaladinFactory("resources/Paladins.txt"),
            new SorcererFactory("resources/Sorcerers.txt"), new WarriorFactory("resources/Warriors.txt")};

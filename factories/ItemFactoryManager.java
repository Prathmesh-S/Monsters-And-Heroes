...
public class ItemFactoryManager {
    ...
    private ItemFactory[] factories = {new WeaponFactory("resources/Weaponry.txt"), new ArmorFactory("resources/Armory.txt"),
            new PotionFactory("resources/Potions.txt"), new SpellFactory("resources/LightningSpells.txt",
            "resources/IceSpells.txt", "resources/FireSpells.txt")};

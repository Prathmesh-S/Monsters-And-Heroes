...
public class PaladinFactory implements HeroFactory {
    ...
    public Hero createCharacter() {
        ...
        // Create a new Paladin object. Assuming level starts at 1 and HP is set to 0 initially.
        return new Paladin(name, level, experiencePoints, mp, 100 * level * 2, strength, dexterity, agility, gold);
    }
}